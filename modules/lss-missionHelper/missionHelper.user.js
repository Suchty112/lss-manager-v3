	...
	function setValues() {
		...
		I18n.translations.en['lssm']['missionHelper'] = {
			...
			vehicles: {
				...
				boot: 'Boats (General)',
				rth: 'Helicopter',
				rdboat: 'Large Rescue Boat',
				fdboat: 'Large Fireboat',
				ktw: 'Ambulances',
		...
		I18n.translations.nl['lssm']['missionHelper'] = {
			...
			vehicles: {
				...
				mess: 'Waarschuwings- en Verkenningsdienst',
				gefahr: 'Adviseur Gevaarlijke Stoffen',
				gwl2: 'Slangenwagen',
				hoehen: 'Hoogte reddingsteam (HRT)',
				...
				nef: 'MMT-Auto',
				rth: 'Lifeliner',
				orgl: 'Officier van Dienst Geneeskunde',
				ktw: 'Zorgambulance',
				polheli: 'Politiehelikopter',
				flf: 'Crashtender',
				taucher: 'Waterongevallenvoertuig',
