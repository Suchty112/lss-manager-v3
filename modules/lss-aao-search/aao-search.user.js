(function ($, I18n) {
    ...
    {
        "use strict";
        $("#mission-aao-group").before('<input type="text" search_class="aao_searchable" class="search_input_field" style="min-width: 400px;" placeholder="'+I18n.t('lssm.aaosearch.search_aao')+'">');
