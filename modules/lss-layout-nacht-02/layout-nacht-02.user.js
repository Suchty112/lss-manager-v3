(function () {
    ...
    $('body').prepend(
        ...
        'html,body,#lightbox_box,.close{background-color:#0a0b0e !important;color:#b9b9b9}html,body.dark,#missions_outer,#bigMapWindow,#lightbox_box,.close{background-color:#0a0b0e !important;color:#b9b9b9}input,textarea{background-color:#151a31!important;border:0} .progress {background-color: #486683!important}' +
        '</style>'
    );
})();
