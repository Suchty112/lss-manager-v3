(function () {
    ...
    $('body').prepend(
        ...
        'html,body.dark,#missions_outer,#buildings_outer,#chat_outer,#radio_outer,#bigMapWindow,#lightbox_box,.close{background-color:#0a0b0e !important;color:#b9b9b9}body.dark,#iframe-inside-container,#iframe-bottom-content,.navbar,.navbar-default,.navbar-fixed-bottom{background-color:#13151b!important;color:#b9b9b9!important}' +
